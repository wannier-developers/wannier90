...
106 call io_error('Error: Problem opening file kpoint.dat in pw90common_wanint_get_kpoint_file', stdout, seedname)
  ...
  subroutine pw90common_wanint_param_dist(verbose, rs_region, kmesh_info, k_points, num_kpts, &
    ...
    use pw90_parameters, only: pw90_calculation_type, postw90_common_type, pw90_spin_mod_type, &
      pw90_band_deriv_degen_type, pw90_kpath_mod_type, kslice_type, dos_plot_type, berry_type, &
...
!    call comms_bcast(num_species,1) ! Ivo: not used in postw90, right?
    ...
    call comms_bcast(dos_data%smr%adpt, 1, stdout, seedname, world)
    call comms_bcast(dos_data%smr%index, 1, stdout, seedname, world)
    call comms_bcast(dos_data%kmesh_spacing, 1, stdout, seedname, world)
    call comms_bcast(dos_data%kmesh(1), 3, stdout, seedname, world)
    call comms_bcast(dos_data%smr%max, 1, stdout, seedname, world)
    call comms_bcast(dos_data%smr%fixed_en_width, 1, stdout, seedname, world)
    call comms_bcast(dos_data%smr%fac, 1, stdout, seedname, world)
...
! Tsirkin
    ...
    call comms_bcast(berry%kubo_smr%adpt, 1, stdout, seedname, world)
    call comms_bcast(berry%kubo_smr%fac, 1, stdout, seedname, world)
    call comms_bcast(berry%kubo_smr%max, 1, stdout, seedname, world)
    call comms_bcast(berry%kubo_smr%fixed_en_width, 1, stdout, seedname, world)
    call comms_bcast(berry%kubo_smr%index, 1, stdout, seedname, world)
    ...
    call comms_bcast(pw90_spin%kmesh(1), 3, stdout, seedname, world)
...
! ----------------------------------------------
    ...
    call comms_bcast(boltz%dos_smr%adpt, 1, stdout, seedname, world)
    call comms_bcast(boltz%dos_smr%fixed_en_width, 1, stdout, seedname, world)
    call comms_bcast(boltz%dos_smr%fac, 1, stdout, seedname, world)
    call comms_bcast(boltz%dos_smr%max, 1, stdout, seedname, world)
    ...
    call comms_bcast(boltz%kmesh_spacing, 1, stdout, seedname, world)
    call comms_bcast(boltz%kmesh(1), 3, stdout, seedname, world)
    ...
    call comms_bcast(boltz%dos_smr%index, 1, stdout, seedname, world)
