...
contains
  ...
  subroutine k_slice(berry, dis_window, fermi_energy_list, kmesh_info, kpt_latt, kslice, &
    ...
    use pw90_parameters, only: pw90_kslice_mod_type, pw90_berry_mod_type, pw90_spin_mod_type, &
      pw90_band_deriv_degen_type, pw90_oper_read_type, pw90_spin_hall_type
    ...
    if (areab1b2 < eps8) call io_error( &
      ...
      //'not linearly independent', stdout, seedname)
    ...
    call utility_recip_lattice(bvec, avec_2d, rdum, stdout, seedname)
    ! Moduli b1,b2,y_vec
