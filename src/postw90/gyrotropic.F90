...
module w90_gyrotropic
  ...
  !======================================================================!
    ...
    real(kind=dp), dimension(:,:,:), intent(out)   :: gyro_K_spn,&
                                                      gyro_K_orb,&
                                                      gyro_D,&
                                                      gyro_C
    real(kind=dp), dimension(:,:,:,:), intent(out) :: gyro_Dw,gyro_NOA_spn,gyro_NOA_orb
    real(kind=dp), dimension(:)      , intent(out) :: gyro_DOS
