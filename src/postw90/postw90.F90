...
program postw90
  ...
  !
  call pw90common_wanint_param_dist(stdout)
  ...
  if (.not. pw90_common%effective_model) then
    ...
    !
    call pw90common_wanint_data_dist(stdout)
    !
  end if
  ...
  !
  if (berry%wanint_kpoint_file) call pw90common_wanint_get_kpoint_file(stdout)
