...
!! then allocate fermi_energy_list with length 1 and set to zero as default.
  ...
  subroutine w90_readwrite_read_eigvals(pw90_effective_model, pw90_boltzwann, pw90_nerwann,  pw90_geninterp, &
                                        w90_plot, disentanglement, eig_found, eigval, library, postproc_setup, &
