...
contains
  ...
  subroutine comms_setup(stdout, seedname)
...
!  end subroutine comms_abort
  ...
  subroutine comms_bcast_int(array, size, stdout, seedname)
  ...
  subroutine comms_bcast_real(array, size, stdout, seedname)
  ...
  subroutine comms_bcast_logical(array, size, stdout, seedname)
  ...
  subroutine comms_bcast_char(array, size, stdout, seedname)
  ...
  subroutine comms_bcast_cmplx(array, size, stdout, seedname)
    !! Send character array from root node to all nodes
  ...
  subroutine comms_send_logical(array, size, to, stdout, seedname)
  ...
  subroutine comms_send_int(array, size, to, stdout, seedname)
  ...
  subroutine comms_send_char(array, size, to, stdout, seedname)
  ...
  subroutine comms_send_real(array, size, to, stdout, seedname)
  ...
  subroutine comms_send_cmplx(array, size, to, stdout, seedname)
  ...
  subroutine comms_recv_logical(array, size, from, stdout, seedname)
  ...
  subroutine comms_recv_int(array, size, from, stdout, seedname)
  ...
  subroutine comms_recv_char(array, size, from, stdout, seedname)
  ...
  subroutine comms_recv_real(array, size, from, stdout, seedname)
  ...
  subroutine comms_recv_cmplx(array, size, from, stdout, seedname)
...
!  end subroutine comms_error
  ...
  subroutine comms_reduce_int(array, size, op, stdout, seedname)
  ...
  subroutine comms_reduce_real(array, size, op, stdout, seedname)
    ...
    if (ierr /= 0) then
      call io_error('failure to allocate array_red in comms_reduce_real', stdout, seedname)
    end if
  ...
  subroutine comms_reduce_cmplx(array, size, op, stdout, seedname)
    ...
    allocate (array_red(size), stat=ierr)
    if (ierr /= 0) then
      call io_error('failure to allocate array_red in comms_reduce_cmplx', stdout, seedname)
    end if
  ...
  subroutine comms_allreduce_real(array, size, op, stdout, seedname)
    ...
    allocate (array_red(size), stat=ierr)
    if (ierr /= 0) then
      call io_error('failure to allocate array_red in comms_allreduce_real', stdout, seedname)
    end if
  ...
  subroutine comms_allreduce_cmplx(array, size, op, stdout, seedname)
    ...
    allocate (array_red(size), stat=ierr)
    if (ierr /= 0) then
      call io_error('failure to allocate array_red in comms_allreduce_cmplx', stdout, seedname)
    end if
  ...
  subroutine comms_gatherv_real_1(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_gatherv_real_2(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_gatherv_real_3(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_gatherv_real_2_3(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_gatherv_cmplx_1(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_gatherv_cmplx_2(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
...
!!    implicit none
  ...
  subroutine comms_gatherv_cmplx_3(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_gatherv_cmplx_3_4(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_gatherv_cmplx_4(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_gatherv_logical(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
    !! Gather real data to root node
    implicit none
...
!    rootglobalarray(1:localcount)=array(1:localcount)
  ...
  subroutine comms_scatterv_real_1(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_scatterv_real_2(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_scatterv_real_3(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_scatterv_cmplx_4(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_scatterv_int_1(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_scatterv_int_2(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
  ...
  subroutine comms_scatterv_int_3(array, localcount, rootglobalarray, counts, displs, stdout, seedname)
