...
wan90.w90_lib_all.read_all_input(data, pw90, plot, tran, "Fe", ftn_output, comm)
...
wan90.w90_lib_all.read_checkpoint(data, pw90, m_matrix, u_matrix, u_opt, ftn_output, comm)
...
if pw90.calculation.dos :
    wan90.w90_lib_all.calc_dos(data, pw90, u_matrix, v_matrix, ftn_output, comm)
