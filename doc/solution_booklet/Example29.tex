...
\begin{figure}[htb!]
\centering
\subfloat[With fixed smearing of 1 eV]{\includegraphics[width=0.45\columnwidth]{figure/example29/Pt-bands+shc_1.pdf}}\qquad
\subfloat[With fixed smearing of 0.05 eV]{\includegraphics[width=0.45\columnwidth]{figure/example29/Pt-bands+shc_0_05.pdf}}
...
\begin{itemize}
	...
	The plot of the Fermi lines with a colormap of $\Omega_{xy}^{\text{spin}z}(k_x,0,k_z)$ is shown in \Fig{fig29.2}.
\end{itemize}

\begin{figure}[htb!]
	\centering
	\subfloat[With fixed smearing of 1 eV]{\includegraphics[width=0.45\columnwidth]{figure/example29/Pt-kslice-shc_1.pdf}}\qquad
	\subfloat[With fixed smearing of 0.05 eV]{\includegraphics[width=0.45\columnwidth]{figure/example29/Pt-kslice-shc_0_05.pdf}}
...
\begin{itemize}
	...
	The converged result reported in Refs.~\onlinecite{qiao-prb2018} and \onlinecite{PhysRevLett92} for the \textit{z}-component is around 2200 $\frac{\hbar}{e}\mathrm{S/cm}$. Hence, a $25\times25\times25$ BZ mesh clearly gives a very inaccurate value ($\sim 22.5\%$ error).   
