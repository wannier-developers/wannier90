...
\begin{itemize}
\item{Outline: \it{Calculate the gyrotropic effects in trigonal right-handed Te}}
...
from the directory {\tt examples/example24/wan_files}. However, this steps are needed 
...
\item Run {\tt pw2wannier90} to compute:
  ...
  \item[{\bf --}] The spin matrix elements $\langle \psi_{n{\bf
        k}}\vert \sigma_i\vert \psi_{m{\bf k}}\rangle$ (written in the
    {\tt Te.spn} file)  (only if spin-orbit is included.
