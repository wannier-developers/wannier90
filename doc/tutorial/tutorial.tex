...
\begin{itemize}
	\item{Outline: \it{Calculate the spin Hall
			conductivity of fcc Pt with spin-orbit coupling. In preparation for this example
			it may be useful to read Ref.~\cite{qiao-prb2018} and Ch.~12.5 of the User Guide.}}
...
large fixed smearing of 1 eV is used for the comparison. 
...
\end{quote} } 
and set the Fermi energy as a value
{\tt
	\begin{quote}
		fermi\_energy = [insert your value here]
\end{quote} } 
...
the output file will contain SHC calculated at different Fermi 
energies: we call this the ``Fermi energy scan'' of SHC. 
