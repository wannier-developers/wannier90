...
To constrain the centre of the SLWF you need to add \mbox{{\tt sel\_loc\_constrain = true}} and \\ 
...
Does the chosen value of the Lagrange multiplier {\tt sel\_loc\_constrain\_lambda} give a SLWF function centred on the As atom?   

Alternatively, you can modify the {\tt centre\_constraints} block to constrain the centre of the SLWF to be on the Ga atom. 
