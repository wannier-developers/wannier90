...
with additional $3d$ projectors to describe high-energy conduction bands.
...
\item Run \wannier\ to generate a list of the required overlaps (written
  into the {\tt silicon.nnkp} file).\\
(note: see {\tt win} input file, no need to specify initial projections, they are
chosen from the pseudo-atomic orbitals inside the {\tt ext\_proj/Si.dat} file)\\
{\tt wannier90.x -pp silicon}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{silicon_bandsdiff.pdf}
  \caption{Comparison of DFT and Wannier bands for silicon.}\label{fig:silicon_bandsdiff}
  \end{center}
\end{figure}
...
\begin{enumerate}
  ...
  \begin{quote}
    ...
    ! atom\_proj\_exclude = 5 6 7 8 9 14 15 16 17 18\\
  \end{quote}
  }
