...
\end{quote} } (the last instruction can be simplified to {\tt
...
\item The Berry curvature in bcc Fe results from the magnetic order
  ...
  planes in the BZ. Note that while locally nonzero, the BZ integral
  of the Berry curvature vanishes because $\bm{\Omega}(-{\bf
    k})=-\bm{\Omega}({\bf k})$.
