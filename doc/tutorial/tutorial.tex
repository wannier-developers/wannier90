...
\begin{itemize}
\item IS: We should think of using bibtex for the growing number
  references (to automatically order them). GP: I agree.
...
%A suitable path has been specified in {\tt Fe.win}.
%{\tt
%\begin{quote}
%begin kpoint\_path
