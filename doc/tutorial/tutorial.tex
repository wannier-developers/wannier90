...
the value of the Fermi energy taken from
  {\tt scf.out}. 
%Note the exchange splitting between the majority- and
%  minority-spin DOS.
}
...
kslice\_task = energy\_isocontours

kslice\_isocontour\_energy = 12.6285
...
contours''), can be visualized with the script {\tt Fe\_econtours.gnu}
generated during runtime, {\tt
\begin{quote}
myshell> gnuplot

gnuplot> load `Fe\_econtours.gnu'
\end{quote} }
%{\tt
...
kslice\_task = energy\_isocontours+curv\_heatmap
