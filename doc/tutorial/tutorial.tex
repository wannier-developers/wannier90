...
\medskip
%
Compare with Fig.~3 in Ref.~\cite{qiao-prb2018}, or 
...
{\tt
	\begin{quote}
		...
		\#kubo\_smr\_fixed\_en\_width = 1
\end{quote} }
Then set the Fermi energy as a value
{\tt
	\begin{quote}
		fermi\_energy = [insert your value here]
\end{quote} } 
...
\begin{itemize}
	...
	\item Adaptive kmesh refinement is not implemented for ac SHC calculations.
