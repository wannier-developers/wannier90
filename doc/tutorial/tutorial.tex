...
\item Run \pwscf\ to obtain the Bloch states on a uniform k-point
  grid. Note that we rquest the lower 4 (valence) bands\\ 
...
files {\tt cnt55\_qc.dat} and {\tt cnt55\_dos.dat}, respectively. Use a
package such as {\tt gnuplot} or {\tt xmgrace} in order to visualise
them. You should get something that looks like Fig.~\ref{fig:cnt.tran}.
\end{enumerate}
...
\bibitem{W90} A.~A.~Mostofi, J.~R.~Yates, Y.-S.~Lee, I.~Souza,
   ...
   submitted (2007) and {\tt http://arxiv.org/abs/0708.0650}.
...
\bibitem{WanTran} Y.-S.~Lee, M.~B.~Nardelli and N.~Marzari, Band
  ...
  Localized Wannier Funtions: The Case of Functionalized carbon
