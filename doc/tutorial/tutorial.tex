...
and {\tt defected/Na\_chain\_dos.dat}, respectively. 
...
\begin{figure}[h]
\begin{center}
\scalebox{0.3}{\includegraphics{Na_qc.eps}}
...
\begin{enumerate}
\item Run \pwscf\ and \wannier. Note that these calculations can be 
quite lengthy.\\ 
\item The quantum conductance and density of states are written to the
...
\emph{Note that to run this section of the tutorial
approximately 9.2Gb of disk space is required. In addition, approximately 6.5Gb
of memory is needed for the transport calculation.}
...
\begin{figure}[h]
\begin{center}
\scalebox{0.3}{\includegraphics{cnt_qc.eps}}
