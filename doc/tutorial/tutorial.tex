...
two seminal papers of Refs.~\cite{MV,SMV}, a recent review
article~\cite{RMP} and to a paper~\cite{W90} describing \wannier.
...
it \emph{cannot} be run in parallel using MPI libraries. On the contrary, the {\tt postw90} executable can be run in parallel
to speed up the calculations, using the MPI libraries.

To enable the parallel version to be built, you must specify some flags in the
