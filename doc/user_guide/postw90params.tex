...
\begin{tabular}{|c|c|p{6cm}|}
  ...
  {\sc dos\_adpt\_smr\_fac} & R & Adaptive smearing prefactor\\
  {\sc dos\_adpt\_smr\_max} & P & Maximum allowed value for the adaptive energy smearing (eV) \\
...
\begin{tabular}{|c|c|p{6cm}|}
  ...
  {\sc optics\_adpt\_smr\_fac} & R & Adaptive smearing prefactor \\
  {\sc optics\_adpt\_smr\_max} & P & Maximum allowed value for the 
...
{\sc boltz\_dos\_adpt\_smr\_fac} & R & Adaptive smearing prefactor\\
