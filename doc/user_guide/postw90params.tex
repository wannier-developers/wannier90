...
\begin{tabular}{|c|c|p{6cm}|}
  ...
  {\sc berry\_interp\_mesh} & I & Uniform interpolation $k$-mesh 
  ...
  $k$-mesh\\ 
  {\sc berry\_adaptive\_thresh} & R & Threshold value of the Berry curvature or 
  $k$-space orbital magnetization for adaptive refinement\\ 
  {\sc optics\_time\_parity}& L & Time parity of the optical conductivity tensor\\ 
  ...
  {\sc optics\_max\_allowed\_smearing} & R & Maximum allowed value for the 
...
\subsection[dos\_smr\_en\_width]{\tt  character(len=120) :: dos\_smr\_type}

Defines the analytical form used for the broadened delta function in
the computation of the DOS.

\hspace{0.5cm}
\textcolor{red}{bla: derivative of the corresponding Methfessel-Paxton function}

\hspace{0.5cm}
\textcolor{red}{bla: derivative of the cold-smearing function}

\hspace{0.5cm}
\textcolor{red}{bla: derivative of the Fermi-Dirac distribution function}
