...
The default value is $0~\mathrm{K}$ (\textit{i.e.~}, step-function occupations are used). Note that a finite temperature $(T>0~\mathrm{K})$ is always needed in order to account for Fermi-surface integrations.
