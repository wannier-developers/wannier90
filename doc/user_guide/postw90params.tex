...
May contain one or more of the following valid options (notem that each option starts with a '-'):
...
\subsubsection{output data format \label{sec:gyrotropic:format}}
