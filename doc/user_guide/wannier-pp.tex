...
In the develop branch on the GitHub repository, the automatic generation of initial projections with spinor-WFs is implemented in the {\tt pw2wannier90} interface. See Example 31 in the \wannier\ tutorial that shows how to use it.
