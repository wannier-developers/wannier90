...
{\noindent \bf \verb#wannier_setup(mp_grid,num_kpts,real_lattice,recip_lattice,kpt_latt,#\\
\verb#              num_bands_tot,num_atoms,atom_symbols,atoms_cart,nntot,nnlist,nncell,#\\
\verb#              num_bands,num_wann,proj_site,proj_l,proj_m,proj_radial,proj_z,#\\
\verb#              proj_x,proj_zona,proj_box,exclude_bands)   #}
...
\item \verb#integer, intent(out) :: num_wann#\\ The number of Wannier
...
{\noindent \bf \verb#wannier_run(mp_grid,num_kpts,real_lattice,recip_lattice,kpt_latt,num_bands,num_wann,#\\
