...
Fermi energy in the specified range\\
  ...
  {\sc u\_matrices\_plot } & L & Write U and U\_{dis} matrices to files \\
...
\subsection[u\_matrices\_plot]{\tt logical :: u\_matrices\_plot}

Write the U matrix and the U\_{dis} matrices obtained at the end of wannierization to files
