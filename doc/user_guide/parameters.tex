...
{\sc num\_proj }   & I & Number of projections defined \\
...
\subsection[num\_proj]{\tt integer :: num\_proj}

Total number of projections that have been defined in the projections block.
This only needs to be specified if the number of projections is greater than the number of Wannier functions.
In that case, use \verb#select_projections# to select the initial projections that are used for wannierisation.

Default \verb#num_proj#=\verb#num_wann#
