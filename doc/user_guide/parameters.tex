...
%{\sc hr\_min} & R & Cut-off for Hamiltonian matrix elements \\
...
%%\subsection[hr\_min]{\tt real(kind=dp) :: hr\_min}
%%
...
%%  hr\_min}, then the matrix elements 
...
%%and are discarded. Only applies if {\tt hr\_plot} is {\tt TRUE}.  
%%
%%The default is 0.0
