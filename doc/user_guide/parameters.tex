...
{\sc tran\_wf\_threshold } & R & Threshold for WF integrals to be considered zero \\
{\sc hr\_cutoff} & P &  Cut-off for the absolute value of the Hamiltonian \\
{\sc dist\_cutoff} & P & Cut-off for the distance between WF \\
{\sc dist\_cutoff\_mode} & S & Dimension in which the distance between WF
is calculated \\
...
\subsection[tran\_wf\_thresfold]{\tt real(kind=dp) :: tran\_wf\_thresfold}

Parity integrals found during automated lcr calculations (see Section~\ref{sec:2c2})
are considered zero if their value is below \verb#tran_wf_threshold#.
