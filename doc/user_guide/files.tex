...
When performing selective localization (the SLWF method) only few things change in the output file
and in general the same principles shown in the above section will apply. It is strongly
recommended, that the reader has acquired some familiarity with   
...
% AAM: WHY NEED THIS EXTRA LINE WHEN LAMBDA IS FIXED?
\begin{verbatim}
      1    -0.884E-01     0.2093698260       -3.2536918930       0.00  <-- CONV
    0.100E+01
\end{verbatim}
