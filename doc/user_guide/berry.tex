...
%The method by Qiao is, using $1\approx\sum_{ l\in ab\,initio{\rm \,bands}}|l\bm{k}\rangle \langle l\bm{k}|$, calculate the matrix as
%\begin{equation}
