...
function to project onto `up' states and a set to project onto `down'
...
1. 18 projections on an iron site
...
4. same as above but quantisation axis is now x

\verb#Fe:sp3d2;dxy;dxz;dyz(u,d)[1,0,0]#

5.  now only 8 projections onto up states

\verb#Fe:sp3d2;dxy;dxz;dyz(u)#
           
6. 9 projections onto up-states and 3 on down

\verb#Fe:sp3d2;dxy;dxz;dyz(u) #\\
\verb#Fe:dxy;dxz;dyz(d)#                 

7. projections onto alternate spin states for two lattice sites (Cr1, Cr2)
