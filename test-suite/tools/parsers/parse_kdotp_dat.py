"""
Parser function parse() to parse the <seedname>-2-kdotp.dat output file of postw90.x.
...
def parse(fname):
    ...
    for lno, l in enumerate(lines):
        ...
        if len(pieces) == 2 : 
            retdict['real_part'].append(float(pieces[0]))
            retdict['imag_part'].append(float(pieces[1]))
