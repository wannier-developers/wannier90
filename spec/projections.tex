...
coordinates in units determined by the keyword \verb#length_unit#
...
\verb#ang_mtm#:\\
 ...
 \verb#l=-1 # or \verb# sp3# -- four sp$^{3}$ hybrids\\
 Specific hybrid orbitals may be specified as follows:\\
 \verb#l=-1,mr=1,3 # or \verb# sp3-1,sp3-3# -- two specific sp$^{3}$ hybrids\\
 Multiple states may be specified by separating with 
 `\verb#;#', e.g.,\\
 \verb#sp3;l=0 # or \verb# l=-1;l=0# -- four sp$^{3}$ hybrids and one s orbital
